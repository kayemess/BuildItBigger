 ...
 * on 2017-02-28 at 05:44:02 UTC 
 * Modify at your own risk.
 */

package com.example.kristenwoodward.myapplication.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_SERVICE_PATH = "myApi/v1/myjoke/";
   ...
   * @return the request
   */
  public GetJoke getJoke(java.lang.Integer radomInt) throws java.io.IOException {
    GetJoke result = new GetJoke(radomInt);
    initialize(result);
    return result;
  }

  public class GetJoke extends MyApiRequest<com.example.kristenwoodward.myapplication.backend.myApi.model.MyJoke> {

    private static final String REST_PATH = "{radomInt}";
     ...
     * @since 1.13
     */
    protected GetJoke(java.lang.Integer radomInt) {
      super(MyApi.this, "GET", REST_PATH, null, com.example.kristenwoodward.myapplication.backend.myApi.model.MyJoke.class);
      this.radomInt = com.google.api.client.util.Preconditions.checkNotNull(radomInt, "Required parameter radomInt must be specified.");
    }
    ...
    private java.lang.Integer radomInt;

    /**

     */
    public java.lang.Integer getRadomInt() {
      return radomInt;
    }

    public GetJoke setRadomInt(java.lang.Integer radomInt) {
